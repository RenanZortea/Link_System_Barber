...
import {
  ...
  pieArcClasses,
  pieArcLabelClasses
} from "./chunk-56SSYYBF.js";
import "./chunk-A2BZ5AHP.js";
import {
  AnimatedArea,
  AnimatedLine,
  AreaElement,
...
import "./chunk-F32GU6SD.js";
import "./chunk-U7OTEWRA.js";
import "./chunk-Q3YUISDZ.js";
import "./chunk-GJ5PGLZ3.js";
import {
  init_styles
} from "./chunk-ARKR4PLC.js";
import "./chunk-ATJ2L2QU.js";
import "./chunk-Y2PDEAIT.js";
import {
  styled_default
...
function Scatter(props) {
  ...
  return (0, import_jsx_runtime5.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime5.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
function ScatterPlot(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React6.useContext(ZAxisContext);
  ...
  return (0, import_jsx_runtime6.jsx)(React6.Fragment, {
    children: seriesOrder.map((seriesId) => {
      ...
      const xScale = xAxis[xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime6.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color,
        colorGetter,
...
var ScatterChart = React7.forwardRef(function ScatterChart2(props, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(ResponsiveChartContainer, {
    ref,
    ...
    highlightedItem,
    onHighlightChange,
    children: (0, import_jsx_runtime7.jsxs)(ZAxisContextProvider, {
      zAxis,
      children: [!disableVoronoi && (0, import_jsx_runtime7.jsx)(ChartsVoronoiHandler, {
        voronoiMaxRadius,
        onItemClick
      }), (0, import_jsx_runtime7.jsx)(ChartsAxis, {
        topAxis,
        leftAxis,
        rightAxis,
        bottomAxis,
        slots,
        slotProps
      }), grid && (0, import_jsx_runtime7.jsx)(ChartsGrid, {
        vertical: grid.vertical,
        horizontal: grid.horizontal
      }), (0, import_jsx_runtime7.jsx)(ScatterPlot, {
        slots,
        slotProps,
        onItemClick: disableVoronoi ? onItemClick : void 0
      }), (0, import_jsx_runtime7.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
        ...
        slots,
        slotProps
      })), (0, import_jsx_runtime7.jsx)(ChartsAxisHighlight, _extends({
        x: "none",
        y: "none"
      }, axisHighlight)), !loading && (0, import_jsx_runtime7.jsx)(ChartsTooltip, _extends({
        trigger: "item"
      }, tooltip)), children]
    })
  });
...
true ? ScatterChart.propTypes = {
   ...
   */
  bottomAxis: import_prop_types5.default.oneOfType([import_prop_types5.default.object, import_prop_types5.default.string]),
   ...
   */
  leftAxis: import_prop_types5.default.oneOfType([import_prop_types5.default.object, import_prop_types5.default.string]),
  /**
   ...
   * @default null
   */
  rightAxis: import_prop_types5.default.oneOfType([import_prop_types5.default.object, import_prop_types5.default.string]),
  /**
   ...
   * @default null
   */
  topAxis: import_prop_types5.default.oneOfType([import_prop_types5.default.object, import_prop_types5.default.string]),
...
var SparkLineChart = React8.forwardRef(function SparkLineChart2(props, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(ResponsiveChartContainer, {
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime8.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime8.jsxs)(React8.Fragment, {
      children: [(0, import_jsx_runtime8.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime8.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime8.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime8.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime8.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  });
...
function GaugeProvider(props) {
  ...
  return (0, import_jsx_runtime9.jsx)(GaugeContext.Provider, {
    value: contextValue,
    children
  });
}
...
var GaugeContainer = React10.forwardRef(function GaugeContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime10.jsx)(ResizableContainer, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime10.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      svgRef,
      children: (0, import_jsx_runtime10.jsx)(GaugeProvider, {
        value,
        valueMin,
        valueMax,
        startAngle,
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime10.jsx)(ChartsSurface, {
          width,
          height,
          ref: handleRef,
          title,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(StyledPath, _extends({
...
function GaugeReferenceArc(props) {
  ...
  return (0, import_jsx_runtime12.jsx)(StyledPath2, _extends({
    transform: `translate(${cx}, ${cy})`,
    d: arc_default().cornerRadius(cornerRadius)({
      startAngle,
      endAngle,
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime13.jsx)("g", {
    className,
    children: (0, import_jsx_runtime13.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
function Gauge(props) {
  ...
  return (0, import_jsx_runtime14.jsxs)(GaugeContainer, _extends({}, other, {
    className: classes.root,
    children: [(0, import_jsx_runtime14.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime14.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime14.jsx)(GaugeValueText, {
