...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React4.useRef({
    x: -1,
    y: -1
  });
  React4.useEffect(() => {
...
var ChartsSurface = React5.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
function useChartGradient() {
  ...
  return React8.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  const {
    ...
    yAxisIds,
    yAxis
  } = React8.useContext(CartesianContext);
...
var HighlightedContext = React9.createContext({
...
function HighlightedProvider({
  ...
  const seriesById = React10.useMemo(() => {
  ...
  const providerValue = React10.useMemo(() => {
    return {
      highlightScope,
      highlightedItem,
...
function useHighlighted() {
  const highlighted = React11.useContext(HighlightedContext);
...
function useItemHighlighted(item) {
  const highlighted = React12.useContext(HighlightedContext);
  if (highlighted === void 0) {
    throw new Error(["MUI X: Could not find the highlighted ref context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!item) {
...
var ZAxisContext = React13.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React13.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
var ChartContainer = React14.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
    ...
    children: (0, import_jsx_runtime8.jsx)(SeriesContextProvider, {
      ...
      children: (0, import_jsx_runtime8.jsx)(CartesianContextProvider, {
        ...
        children: (0, import_jsx_runtime8.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime8.jsx)(HighlightedProvider, {
            highlightedItem,
            onHighlightChange,
            children: (0, import_jsx_runtime8.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
...
//# sourceMappingURL=chunk-W5UESXR2.js.map
